...
include_once("sub_header.php");?>
        ...
        <table class="table table-style5 bg-color-light1">
...
$i = 1;
foreach($financial_performance->result() as $row){ ?>

<tr>
                  <td><?php echo $i;?></td>
                  <td><?php echo $row->year;?></td>
                  <td><?php echo $row->net_revenue;?></td>
                  <td><?php echo $row->expences; ?></td>
                  <td><?php echo $row->EBICD; ?></td>
                  <td><?php echo $row->interest_Determination; ?></td>
                  <td><?php echo $row->provision_of_tax; ?></td>
                  <td><?php echo $row->networth; ?></td>
                  <td><?php echo $row->ERP; ?></td>
                  <td><?php echo $row->cane_price; ?></td>   
