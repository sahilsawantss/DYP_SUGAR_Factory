...
include_once("sub_header.php");?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-center textCenter">
                            <h5 class="heading wow fadeInUp" data-wow-delay="0.1s">What We Do</h5>
                        </div>
                        <div class="col-lg-8 col-center mb100 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="blockquote blockquote-style1 border0">
                                <i class="fas fa-quote-left fLeft quoteIcon"></i>
                                <blockquote class="textCenter">ellentesque in enim sit amet justo venenatis ullamcorper sollicitudin vitae risus. Nunc suscipit lacus faucibus libero dictum, et aliquet leo sagittis. In a mollis libero. Aliquam lacinia ornare tortor at commodo. Donec vitae leo sagittis, dignissim lacus imperdiet, vehicula quam. Fusce nibh nunc, congue nec convallis a, laoreet et ipsum. Proin scelerisque velit a ante pretium consectetur.
                                </blockquote>
                            </div>
                        </div>
                    </div>
        ...
        <section class="parallax parallax-light-pattern sectionPT sectionPB" style="background-image: url('img/bg/pattern-bg-2.png');">
            <div class="container pl0 pr0">
                <div class="row pl0 pr0">
                 
                    <div class="col-lg-12 col-md-12  pt90 pb90 bg-color-colorPrimary">
                        <div class="col-md-12 col-center textCenter mb30">
                            <h5 class="heading text-color-white1 wow fadeInUp">सध्या या क्षेत्रातील कोणतीही माहिती उपलब्ध नाही आहे .</h5>
                            <p class="sub-heading-bottom text-color-white1 wow fadeInUp" data-wow-delay="0.2s">कृपया अधिक माहितीसाठी संपर्क करा. </p>
                        </div>
                        <div class="col-md-8 col-center wow fadeInUp" data-wow-delay="0.3s">
                            <form class="subscription-form subscription-form-style3 needs-validation" novalidate> 
                                <div class="form-row">
                                    <div class="col-md-10 col-sm-10 col-9 padding0">
                                        <input type="text" name="email" class="form-control" placeholder="Enter your email" required="">
                                    </div>
                                    <div class="col-md-2 col-sm-2 col-3 padding0">
                                        <button class="btn btn-dark"><i class="fas fa-angle-right"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <section class="sm-sectionPT sm-sectionPB bg-color-light1">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-12 padding0 wow fadeInLeft">
                        <div class="text-box text-box-style8">
                            <span class="far fa-edit grid_icon mb20"></span>
                            <div class="content">
                                <p class="heading-sm mb10 ">नम्रता</p>
                                <p class="grid_description_text">म्रता म्हणजे काय योग्य आहे आणि कोण योग्य नाही याची काळजी आहे.
नम्रतेशिवाय परिपूर्णता अशक्य आहे. नम्रता ही आपली अंतिम शक्ती आहे, ती आपली नेतृत्व करण्याची क्षमता आहे तितकी अनुसरण करण्याची आपली इच्छा आहे. हे आपल्या स्वतःचे खरे मोजमाप शोधते आणि शिकण्याच्या आणि वाढण्याच्या दिशेने आपले रूपांतर करते. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 padding0 wow fadeInUp">
                        <div class="text-box text-box-style8">
                            <span class="far fa-clone grid_icon mb20"></span>
                            <div class="content">
                                <p class="heading-sm mb10 ">विश्वास आणि आदर</p>
                                <p class="grid_description_text">विश्वास निर्माण व्हायला वर्षे लागतात, तुटायला काही सेकंद लागतात आणि दुरुस्त व्हायला कायमचा. आदर मिळतो, विश्वास मिळतो. दोघे मिळून आपल्या अद्वितीय मूल्याची आठवण करून देतात, आपली एकत्रित शक्ती गुणाकार करतात आणि आपल्यापैकी प्रत्येकजण सक्षम असलेल्या चमत्कारांची आठवण करून देतात.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 padding0 wow fadeInRight">
                        <div class="text-box text-box-style8">
                            <span class="far fa-envelope-open grid_icon mb20"></span>
                            <div class="content">
                                <p class="heading-sm mb10 ">वचनबद्धता</p>
                                <p class="grid_description_text">प्रेरणा तुम्हाला सुरुवात करते, वचनबद्धता तुम्हाला पुढे चालू ठेवते. आमचा विश्वास आहे की वचनबद्धता ही शक्ती आहे जी वचनाचे वास्तवात रूपांतर करते. हे बंधन आहे जे आपल्याला आपल्या ध्येयांशी चिकटून राहते आणि आपल्याला हे समजण्यास मदत करते की यश कधीही अपघाताने मिळत नाही. हे आपल्याला विश्वास देते की जिथे इच्छा आहे तिथे नेहमीच मार्ग असतो.</p>
                            </div>
                        </div>
                    </div>
                </div>
